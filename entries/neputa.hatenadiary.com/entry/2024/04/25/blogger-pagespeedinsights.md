...
[f:id:neputa:20260902234812w:plain:title=モバイル:alt=PageSpeed Insights モバイルの結果]

[f:id:neputa:20260902234820w:plain:title=デスクトップ:alt=PageSpeed Insights デスクトップの結果]
...
[f:id:neputa:20260902234827w:plain:alt=Blogger標準JSの読み込み結果]
...
> タグ内に埋め込まれる JavaScript 表記。<br>
> [構造化データ マークアップとは | Google 検索セントラル | ドキュメント | Google for Developers](https://developers.google.com/search/docs/appearance/structured-data/intro-structured-data?hl=ja)より引用
...
[https://www.bugbugnow.net/:embed:cite]
