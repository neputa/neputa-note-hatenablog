...
![VSCode アラートポップアップ](../assets/images/vscode-alertwindow.webp)

- またインストールディレクトリ内に変更をおよぼす拡張機能のため、タイトルバーに「サポート対象外」と表示されるようになる

![VSCode サポート対象外の表示](../assets/images/vscode-notsupport.webp)
...
![VSCode リスタートのポップアップ](../assets/images/vscode-restart-popup.webp)
...
![VSCode背景画像](../assets/images/vscode-backgroundimage.webp)
