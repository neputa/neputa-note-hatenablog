...
![cloudflareのネットワーク拠点をプロットした世界地図](../assets/images/hero__cloudflare_ttfb.webp)
...
![PageSpeed Insightsによる測定結果](../assets/images/pagespeedinsights-ttfb.webp)
...
![KeyCDN Toolsによる測定](../assets/images/keycdn-tools.webp)
