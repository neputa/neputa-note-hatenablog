...
![アイキャッチ画像](../assets/images/hero__2021__10__blogpost06.webp)
...
3. 画面左の「キーボードとマウス」を選択肢、「追加のレイアウトオプション」をクリック
    ...
    ![gnome-tweaks 01](../assets/images/8251798724985751767-tweaks-01.webp)

4. Ctrl positionの「Caps LockをCtrlとして扱う」にチェック

    ![gnome-tweaks 02](../assets/images/8251798724985751767-tweaks-02.webp)

5. Caps Lock behaviorの「Caps Lock is also a Ctrl」を選択

    ![gnome-tweaks 03](../assets/images/8251798724985751767-tweaks-03.webp)
...
2. 左のメニューから「地域と言語」を選択肢、「日本語（Mozc）」の歯車をクリック
    ...
    ![mozc キー設定 01](../assets/images/8251798724985751767-mozc-shortcut-01.webp)

3. 「Mozcプロパティ」ウインドウの、「キー設定」→「キー設定の選択」にある「編集ボタン」をクリック

    ![mozc キー設定 02](../assets/images/8251798724985751767-mozc-shortcut-02.webp)

4. 「Mozcキー設定」ウインドウの「コマンド」をクリックしてソートし、「IMEを無効化」「IMEを有効化」の行をすべて右クリックから削除する

    ![mozc キー設定 03](../assets/images/8251798724985751767-mozc-shortcut-03.webp)
...
1. 先ほどのUbuntu設定アプリを開き、右側のメニューから「キーボードショートカット」を選択する
    ...
    ![ubuntu settings 01](../assets/images/8251798724985751767-keyboard-shortcut-01.webp)

2. タイピングの「前の入力ソースへと切り替える」と「次の入力ソースへ切り替える」それぞれ、ダブルクリックし、ESCキーを押して「無効」にする

    ![fcitx 01](../assets/images/8251798724985751767-keyboard-shortcut-02.webp)
...
![fcitx 01](../assets/images/8251798724985751767-fcitx-01.webp)
