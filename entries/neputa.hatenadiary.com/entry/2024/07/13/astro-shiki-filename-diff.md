...
URL: https://www.neputa-note.net/entry/2024/07/13/astro-shiki-filename-diff
...
> Shiki（式、日本語で「スタイル」の意）は、VS Codeのシンタックスハイライトと同じエンジンであるTextMateの文法とテーマをベースにした、美しく強力なシンタックスハイライターです。ほとんどの主要なプログラミング言語に対して、非常に正確で高速なシンタックスハイライトを提供します。<br>
> -- [Shiki公式](https://shiki.style/guide/)より引用をDeepLで翻訳
...
[https://blog.mono0x.net/2023/07/10/astro-syntax-highlight-with-title/:embed:cite]
