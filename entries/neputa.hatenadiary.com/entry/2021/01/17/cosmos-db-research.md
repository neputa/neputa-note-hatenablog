...
[f:id:neputa:20260826224420w:plain:alt=アイキャッチ画像]
...
[https://ryuichi111std.hatenablog.com/entry/2017/05/21/012928:embed:cite]
...
> 要求ユニット (RU) とは、Azure Cosmos DB におけるスループットの単位です。 1 RU のスループットは、1 KB のドキュメントを取得するスループットに相当します。<br>
> -- [よく寄せられる質問 - Azure Cosmos DB | Microsoft Learn](https://learn.microsoft.com/ja-jp/azure/cosmos-db/faq#how-does-azure-cosmos-db-offer-predictable-performance)
...
> 効率的な接続管理と SDK クライアントのパフォーマンス向上を実現するために、アプリケーションの有効期間中は、AppDomainごとに単一のインスタンスを使用することをお勧めします。<br>
> [.NET SDK v3 用の Azure Cosmos DB のパフォーマンスに関するヒント | Microsoft Learn](https://learn.microsoft.com/ja-jp/azure/cosmos-db/nosql/performance-tips-dotnet-sdk-v3?tabs=trace-net-core)
...
[日付の操作 - Azure Cosmos DB for NoSQL | Microsoft Learn](https://learn.microsoft.com/ja-jp/azure/cosmos-db/nosql/query/working-with-dates#storing-datetimes)
