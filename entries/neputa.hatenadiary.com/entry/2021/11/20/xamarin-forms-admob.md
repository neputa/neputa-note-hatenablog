...
URL: https://www.neputa-note.net/entry/2021/11/20/xamarin-forms-admob
EditURL: https://blog.hatena.ne.jp/neputa/neputa.hatenadiary.com/atom/entry/14945776032071260695
---

[f:id:neputa:20260830215735w:plain:alt=アイキャッチ画像]
...
[https://github.com/marcojak/MTAdmob:embed:cite]
...
[https://prismlibrary.com/:embed:cite]

### Nugetパッケージのインストール

PCLおよび各Platformプロジェクト（Android、iOS）にNugetパッケージ「MarcTron.Admob」をインストールする。

[f:id:neputa:20260830215741w:plain:alt=説明画像01]

readme.txtが表示されるのでDeepL翻訳にでも放り込んで一読するとよいかも。

[f:id:neputa:20260830215748w:plain:alt=説明画像02]
...
[f:id:neputa:20260830215757w:plain:alt=説明画像03]
...
[f:id:neputa:20260830215804w:plain:alt=説明画像04]

Interstitial広告が表示される

[f:id:neputa:20260830215811w:plain:alt=説明画像05]

## まとめ

今回作成したサンプルプロジェクトは一応github.comに置いているのでご参考まで。

[https://github.com/neputa/AdmobTest:embed:cite]
