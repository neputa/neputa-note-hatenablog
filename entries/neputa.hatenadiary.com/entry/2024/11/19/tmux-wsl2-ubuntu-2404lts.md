...
URL: https://www.neputa-note.net/entry/2024/11/19/tmux-wsl2-ubuntu-2404lts
...
> Starting with tmux version 3.1, \~/.config/tmux/tmux.conf works as an alternative to \~/.tmux.conf. Notice that it cannot be a hidden file in that directory.<br>
> <br>
> tmuxバージョン3.1から、\~/.config/tmux/tmux.confが\~/.tmux.confの代わりとして機能します。 そのディレクトリの隠しファイルにはできないことに注意してください。<br>
> -- [StackExchange](https://unix.stackexchange.com/questions/644819/is-it-possible-to-move-tmux-conf-to-config-folder)より引用を[DeepL翻訳](https://www.deepl.com/ja/translator)で翻訳
...
[f:id:neputa:20260904234157w:plain:alt=tmuxのセッションを展開したスクリーンショット]
