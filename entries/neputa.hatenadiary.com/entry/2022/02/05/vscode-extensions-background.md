...
[f:id:neputa:20260901024353w:plain:alt=VSCode アラートポップアップ]

- またインストールディレクトリ内に変更をおよぼす拡張機能のため、タイトルバーに「サポート対象外」と表示されるようになる

[f:id:neputa:20260901024359w:plain:alt=VSCode サポート対象外の表示]
...
[f:id:neputa:20260901024405w:plain:alt=VSCode リスタートのポップアップ]
...
[f:id:neputa:20260901024412w:plain:alt=VSCode背景画像]
...
> Set the config \{"background.enabled": false\} in settings.json, then uninstall the plugin.<br>
> -- [shalldie / vscode-background - github.com](https://github.com/shalldie/vscode-background)
