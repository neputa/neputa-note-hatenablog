...
CustomPath: 2022/02/15/blazor-wasm-localization
Category:
  - 'DEV'
  - 'dotnet'
...
![アイキャッチ画像](../assets/images/hero__2022__02__blazor-wasm-localization.webp)
...
![ResXManagerスクリーンショット](../assets/images/resxmanager-screenshot.webp)

デバッグ実行し、初回起動時にブラウザLocaleから日本語表示、セレクター切り替えで英語表示になることを確認

![Blazor デモ画面](../assets/images/blazor-demo-1.webp)

![Blazor デモ画面](../assets/images/blazor-demo-2.webp)
