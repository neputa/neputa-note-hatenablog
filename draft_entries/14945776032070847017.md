...
![アイキャッチ画像](../assets/images/hero__2021__10__blogpost05.webp)
...
![設定スクリーンショット01](../assets/images/2451751403680150271-ibus-fcitx_switch-01.webp)

言語サポートウインドウが立ち上がるので、「キーボード入力に使うIMシステム」を「ibus」から「fcitx」に変更し閉じる。

![設定スクリーンショット02](../assets/images/2451751403680150271-ibus-fcitx_switch-02.webp)
