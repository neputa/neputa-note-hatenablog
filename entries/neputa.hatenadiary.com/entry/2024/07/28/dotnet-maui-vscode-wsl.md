...
> [!NOTE]
> Windowsでの環境構築は下の記事を参照

[https://www.neputa-note.net/entry/2024/08/27/dotnet-maui-vscode-windows:embed:cite]
...
> [!WARNING]
> 現時点でOpenJDK 21が公開されているが17をインストールすること（21はサポート外
...
#### 4. source ~/.bash_profileを実行、またはターミナルを再起動して設定を読みこむ
...
[f:id:neputa:20260904021138w:plain:alt=Android Emulator]

> [!WARNING]
> Ubuntuネイティブ環境ではないせいか右のツールバーは操作不可
...
> [!NOTE]
> USERNAMEを自分の環境に修正する。別途javaSDKをインスト―ルした場合はそのPATHを入力する。
...
[f:id:neputa:20260904021146w:plain:title=アプリをデバッグ実行:alt=Android Emulator デバッグ実行]
