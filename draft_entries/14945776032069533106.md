...
CustomPath: 2021/01/20/xunit-trouble-shooting
Category:
  - 'DEV'
...
![アイキャッチ画像](../assets/images/hero__2021__01__xunit-trouble-shooting.webp)
...
![errorメッセージ](../assets/images/640913018085986405-error_statusbar.webp)
...
![拡張機能画面](../assets/images/640913018085986405-LiveShare.webp)
...
![LiveShare uninstall](../assets/images/640913018085986405-LiveShare_Off.webp)

もう一度同じ画面から今度はチェックを入れて「変更」ボタンで再インストールが完了する。

![LiveShare install](../assets/images/640913018085986405-LiveShare_On.webp)

そうするとテストは実行できるようになった。

![test successfully](../assets/images/640913018085986405-output.webp)
