...
URL: https://www.neputa-note.net/entry/2021/01/20/xunit-trouble-shooting
EditURL: https://blog.hatena.ne.jp/neputa/neputa.hatenadiary.com/atom/entry/14945776032069533106
---

[f:id:neputa:20260826224739w:plain:alt=アイキャッチ画像]
...
[f:id:neputa:20260826224746w:plain:alt=errorメッセージ]
...
[f:id:neputa:20260826224754w:plain:alt=拡張機能画面]
...
[f:id:neputa:20260826224801w:plain:alt=LiveShare uninstall]

もう一度同じ画面から今度はチェックを入れて「変更」ボタンで再インストールが完了する。

[f:id:neputa:20260826224808w:plain:alt=LiveShare install]

そうするとテストは実行できるようになった。

[f:id:neputa:20260826224816w:plain:alt=test successfully]
