...
[f:id:neputa:20260904022033w:plain:alt=FrontMatter CMSとVSCodeのロゴ]
...
## Front Matter CMSについて

[https://frontmatter.codes/:embed:cite]

> Visual Studio CodeやGitPodなどで動作するCMS、Front Matterで、両方の世界のベストを体験しましょう。Front MatterのCMS機能を導入して、静的ジェネレータのコンテンツをコントロールしましょう。複雑なセットアップは不要です。Front Matter CMS を選んで、今すぐ素晴らしいコンテンツの作成とプレビューを始めましょう。<br>
> -- [公式サイト](https://frontmatter.codes/)より引用をDeepLで翻訳
...
[f:id:neputa:20260904022042w:plain:title=ダッシュボード:alt=Front Matter CMS ダッシュボード]

[f:id:neputa:20260904022050w:plain:title=エディター表示:alt=Front Matter CMS エディター]
...
https://www.youtube.com/watch?v=xb6pZiier_E:embed
...
[f:id:neputa:20260904022059w:plain:title=設定画面:alt=Front Matter CMS 設定画面]
...
> [!WARNING]
> {{year}}や{{month}}というPlaceholderがあるが、これらはCurrent year or month。よって今回のケースでは使えない。
...
[f:id:neputa:20260904022108w:plain:alt=Front Matter CMS ダッシュボード]

- その他確認できたのは以下
  - mediaDb.jsonは画像等メディアコンテンツを格納
  - pinnedItemsDb.jsonはピン止めした記事を格納

[f:id:neputa:20260904022115w:plain:title=ピン止め:alt=Front Matter CMS ピン止め]
