...
URL: https://www.neputa-note.net/entry/2020/10/15/vscode-editorconfig
...
[f:id:neputa:20260826121445w:plain:alt=blog image]

22エクスプローラーで右クリックをすると「Generate .editorconfig」が表示されるようになるので、クリックするとファイルが生成されます。
[f:id:neputa:20260826121451w:plain:alt=blog image]
...
[f:id:neputa:20260826121458w:plain:alt=blog image]

3.続いて「Enable Roslyn Analyzers」で検索し、同様にチェックボックスにチェックを入れます。

[f:id:neputa:20260826121505w:plain:alt=blog image]
...
[f:id:neputa:20260826121511w:plain:alt=blog image]
...
[f:id:neputa:20260826121518w:plain:alt=thisをfalse-warningに指定した画像]

warningの部分を、suggestionに変更すると、警告ではなく、情報として表示されるようになります。

[f:id:neputa:20260826121524w:plain:alt=thisをfalse-suggestionに指定した画像]
