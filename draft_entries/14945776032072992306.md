...
![Joplin Webクリッパー有効化画面](../assets/images/vscode-joplin-01.webp)

同画面の最下部「詳細な設定」の「認証トークン」をコピーしておく。（VSCodeの拡張機能で使用する）

![Joplin 認証トークン](../assets/images/vscode-joplin-02.webp)

VSCodeに戻り、「拡張機能の設定」を開く。

![VSCode 拡張機能の設定](../assets/images/vscode-joplin-03.webp)

設定最下部の項目「Joplin: Token」に先ほどコピーしたトークンを貼り付ける。

![VSCode Joplin Tokenを貼り付け](../assets/images/vscode-joplin-04.webp)

VSCodeをリロードすると画面左にJoplinのアイコンが表示される。これをクリックまたはショートカットキー[Ctrl]＋[j]→ +[J]で、VScode上にJoplinのノートを展開できる。

条件として、Joplinを常駐起動させておく必要がある。

![VSCodeでJoplinを表示](../assets/images/vscode-joplin-05.webp)
