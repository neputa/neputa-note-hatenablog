...
[f:id:neputa:20260901021816w:plain:alt=アイキャッチ画像]
...
[https://learn.microsoft.com/ja-jp/aspnet/core/blazor/?view=aspnetcore-6.0:embed:cite]
...
[https://www.nuget.org/packages/Microsoft.Extensions.Localization:embed:cite]
...
[f:id:neputa:20260901021823w:plain:alt=ResXManagerスクリーンショット]

デバッグ実行し、初回起動時にブラウザLocaleから日本語表示、セレクター切り替えで英語表示になることを確認

[f:id:neputa:20260901021830w:plain:alt=Blazor デモ画面]

[f:id:neputa:20260901021837w:plain:alt=Blazor デモ画面]
