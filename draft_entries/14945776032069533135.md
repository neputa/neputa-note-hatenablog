...
![blog image](../assets/images/8371934994501811265-one-click-child-links.webp)
...
-「Get it free」のボタンをクリック。
  ![手順１](../assets/images/8371934994501811265-azure-boards-01.webp)

- Azure DeoOpsの組織を選択し、「Install」ボタンをクリック。※権限がない場合は、Administratorへ申請する画面が開くので許可を貰ってください。
  ![手順２](../assets/images/8371934994501811265-azure-boards-02.webp)

- 「You are all set！」が表示されたらインストール完了です。
  ![手順３](../assets/images/8371934994501811265-azure-boards-03.webp)
...
![手順４](../assets/images/8371934994501811265-azure-boards-04.webp)

画面右上の「左矢印」をクリック
![手順５](../assets/images/8371934994501811265-azure-boards-05.webp)

Boardsのエリアにある「Team configuration」をクリック
![手順６](../assets/images/8371934994501811265-azure-boards-06.webp)

画面上の「Templates」をクリック
![手順７](../assets/images/8371934994501811265-azure-boards-07.webp)

「Task」の「New template」をクリック
![手順８](../assets/images/8371934994501811265-azure-boards-08.webp)
...
![手順9](../assets/images/8371934994501811265-azure-boards-09.webp)

「New template」または「Create copy」で必要分をどんどん追加する
![手順10](../assets/images/8371934994501811265-azure-boards-10.webp)

こんな感じになる。画像の赤印は共通のTemplate、黄印はBug、青印はProduct Backlog Item固有の3種を登録した。
![手順11](../assets/images/8371934994501811265-azure-boards-11.webp)

Bugに正しく「Bug固有」と「共通」のテンプレートが追加できるか試してみる。新規作成し保存する。
![手順12](../assets/images/8371934994501811265-azure-boards-12.webp)

保存したら、画面右上の「…」から「1-Click Child-Links」をクリックする
![手順13](../assets/images/8371934994501811265-azure-boards-13.webp)

できた。
![手順14](../assets/images/8371934994501811265-azure-boards-14.webp)
