...
URL: https://www.neputa-note.net/entry/2022/03/09/dotnet-configurationbuilder
...
[https://learn.microsoft.com/ja-jp/dotnet/core/extensions/configuration:embed:cite]
...
> 2. 環境変数<br>
> 3. User Secrets<br>
>    の順番で読み込まれる。appsettings.jsonに（Gitにコミット可能な）デフォルトの値を入れておき、開発環境で別な値が必要な時はUser Secrets、CD環境では環境変数から値を読み込む、みたいな運用ができます。<br>
> -- [cloud.config Tech Blog](https://tech-blog.cloud-config.jp/2019-7-11-how-to-configuration-builder/)より引用
...
[f:id:neputa:20260901024733w:plain:alt=Azure Devops Library]
...
[f:id:neputa:20260901024740w:plain:alt=Azure AppServiceアプリケーション設定]
